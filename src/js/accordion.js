function accordionMenu() {
    const menuItems = document.querySelectorAll('.menu__item'); // полуаем все li элементы
    const menuAccord = document.querySelector('.menu__accardeon'); // полуаем ul элемент
